...
window.onload = function(){
    if(logado){
        ...
        document.getElementById("entrar-button").style.display = "block"
...
function inscrito(){
    alert("Você se aplicou para a vaga com sucesso")
}